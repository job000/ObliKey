...
echo ""
echo "cd /Users/johnmichaelobligar/Documents/Development/ObliKey/backend && railway run --service backend npx prisma migrate resolve --applied 20251028200841_add_door_is_locked_field"
echo ""
echo ""
...
echo "============================================="
echo ""
echo "1. Go to Railway Dashboard → Postgres service"
